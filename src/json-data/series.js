const SERIES = [{
  ...
  "temporadas": 2,
  "episodios": [6, 6],
  "genero": "Ciencia Ficción, Fantasía, Superhéroes",
  "actores": [
    { "nombre": "Tom Hiddleston", "wiki": "https://es.wikipedia.org/wiki/Tom_Hiddleston" },
    { "nombre": "Owen Wilson", "wiki": "https://es.wikipedia.org/wiki/Owen_Wilson" },
    { "nombre": "Sophia Di Martino", "wiki": "https://es.wikipedia.org/wiki/Sophia_Di_Martino" }
  ],
  "descripcion": "El dios de las travesuras, Loki, es llevado a la misteriosa Autoridad de Variación Temporal (TVA) después de robar el Teseracto.",
  "iframe": `<iframe width="560" height="315" src="https://www.youtube.com/embed/KcBStos46EM?si=udEfEyLXR967UM6j" 
...
{
  "tipo": "serie",
  "titulo": "Campeones un Año Despues (Argentina 2022)",
  "temporadas": 1,
  "episodios": [1],
  "genero": "Documental, Deporte",
  "actores": [
